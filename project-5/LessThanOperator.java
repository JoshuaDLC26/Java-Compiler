// =================================================================================================================================
/**
 * Compare operands and return a Boolean: true if the first is less than the second, false otherwise
 */
...
// =================================================================================================================================
     ...
     */
    public LessThanOperator(Token token) {
    ...
    public Type verify(Expression... operands) {
        ...
        for(Expression expression : operands){
            ...
            if(!int_type.equals(expr_type)) Utility.error("Less-than Operation's operand is not an integer", expression._position);
        }
