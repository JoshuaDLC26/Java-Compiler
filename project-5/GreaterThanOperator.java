// =================================================================================================================================
/**
 * Compare operands and return a Boolean: true if the first is greater than the second, false otherwise
 */
...
// =================================================================================================================================
    ...
    public Type verify(Expression... operands) {
        ...
        for(Expression expression : operands){
            ...
            if(!int_type.equals(expr_type)) Utility.error("Greater-than Operation's operand is not an integer", expression._position);
        }
