// =================================================================================================================================
/**
 * Compare operands and return a Boolean: true if the first is greater than or equal to the second, false otherwise
 */
...
// =================================================================================================================================
    ...
    // =============================================================================================================================
    /**
     * Create a greater-than-or-equal-to operator.
     *
     * @param token The token that specifies this operator.
     */
    public GreaterThanEqualOperator(Token token) {
    ...
    public Type verify(Expression... operands) {
        ...
        for(Expression expression : operands){
            ...
            if(!int_type.equals(expr_type)) Utility.error("Greater-than-or-Equal Operation's operand is not an integer", expression._position);
        }
