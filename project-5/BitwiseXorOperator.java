// =================================================================================================================================
/**
 * Return the bitwise XOR (exclusive OR) of the integer inputs
 */
...
// =================================================================================================================================
	...
	if (operands.length < 2) {
	    Utility.abort("BitwiseXorOperator.verify(): Invalid argument count (" + operands.length + ")");
	}
        ...
        for(Expression expression : operands){
            ...
            if(!int_type.equals(expr_type)) Utility.error("Bitwise-Xor Operation's operand is not an integer", expression._position);
        }
	...
	for (int i = 0; i < operands.length - 1; i += 1) {
	    ...
	    // Apply bitwise-XOR to the registers.
	    assembly += "\txor\trax,\trbx\n";
