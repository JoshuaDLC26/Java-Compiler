...
// =================================================================================================================================
    ...
    public Map<String, Procedure>           _procedureTable;
    ...
    public Map<String, VariableDeclaration> _variableTable;
    // =============================================================================================================================
	...
	_procedureTable = new HashMap<String, Procedure>();
	for (Procedure procedure : _procedures) {
	    Procedure oldProcedure = _procedureTable.put(procedure._name, procedure);
	...
	_variableTable = new HashMap<String, VariableDeclaration>();
	for (VariableDeclaration variable : _variables) {
	    VariableDeclaration oldVariable = _variableTable.put(variable._name, variable);
	    if (oldVariable != null) {
	...
	// Prologue: stub code, setting up and starting the code portion of the assembly.
	...
	for (Procedure procedure : _procedures) {
	    ...
	    // Generate the assembly that executes the statement.
