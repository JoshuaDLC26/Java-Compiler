// =================================================================================================================================
/**
 * Return the bitwise AND of the integer inputs
 */
...
// =================================================================================================================================
     ...
     */
    public BitwiseAndOperator(Token token) {
	...
	if (operands.length < 2) {
	    Utility.abort("BitwiseAndOperator.verify(): Invalid argument count (" + operands.length + ")");
	}
        ...
        for(Expression expression : operands){
            ...
            if(!int_type.equals(expr_type)) Utility.error("Bitwise-And Operation's operand is not an integer", expression._position);
        }
	...
	for (int i = 0; i < operands.length - 1; i += 1) {
	    ...
	    // Apply bitwise-AND to the registers.
